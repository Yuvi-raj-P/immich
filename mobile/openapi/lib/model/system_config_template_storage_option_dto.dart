...
class SystemConfigTemplateStorageOptionDto {
  ...
  static Map<String, SystemConfigTemplateStorageOptionDto> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            SystemConfigTemplateStorageOptionDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<SystemConfigTemplateStorageOptionDto>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
