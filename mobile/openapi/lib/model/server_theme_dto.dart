...
class ServerThemeDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is ServerThemeDto && other.customCss == customCss;
  ...
  static List<ServerThemeDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ServerThemeDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ServerThemeDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
