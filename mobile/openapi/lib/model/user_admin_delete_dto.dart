...
class UserAdminDeleteDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is UserAdminDeleteDto && other.force == force;
  ...
  static List<UserAdminDeleteDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UserAdminDeleteDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserAdminDeleteDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
