...
class SystemConfigThemeDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is SystemConfigThemeDto && other.customCss == customCss;
  ...
  static List<SystemConfigThemeDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SystemConfigThemeDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SystemConfigThemeDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
