...
class PeopleUpdateDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is PeopleUpdateDto && _deepEquality.equals(other.people, people);
  ...
  static List<PeopleUpdateDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PeopleUpdateDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PeopleUpdateDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
