...
class ActivityStatisticsResponseDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is ActivityStatisticsResponseDto && other.comments == comments;
  ...
  static List<ActivityStatisticsResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ActivityStatisticsResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ActivityStatisticsResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
