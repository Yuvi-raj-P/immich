...
class AvatarUpdate {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is AvatarUpdate && other.color == color;
  ...
  static List<AvatarUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AvatarUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AvatarUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
