...
class JobSettingsDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is JobSettingsDto && other.concurrency == concurrency;
  ...
  static List<JobSettingsDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<JobSettingsDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = JobSettingsDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
