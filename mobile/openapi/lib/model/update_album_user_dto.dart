...
class UpdateAlbumUserDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdateAlbumUserDto && other.role == role;
  ...
  static List<UpdateAlbumUserDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UpdateAlbumUserDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UpdateAlbumUserDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
