...
class UpdateTagDto {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is UpdateTagDto && other.name == name;
  ...
  static List<UpdateTagDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UpdateTagDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UpdateTagDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
