...
class SystemConfigNewVersionCheckDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is SystemConfigNewVersionCheckDto && other.enabled == enabled;
  ...
  static List<SystemConfigNewVersionCheckDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SystemConfigNewVersionCheckDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SystemConfigNewVersionCheckDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
