...
class UserPreferencesUpdateDto {
  ...
  @override
  String toString() =>
      'UserPreferencesUpdateDto[avatar=$avatar, download=$download, emailNotifications=$emailNotifications, memories=$memories, purchase=$purchase]';
  ...
  static UserPreferencesUpdateDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserPreferencesUpdateDto(
        ...
        emailNotifications:
            EmailNotificationsUpdate.fromJson(json[r'emailNotifications']),
  ...
  static List<UserPreferencesUpdateDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UserPreferencesUpdateDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UserPreferencesUpdateDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
