...
class MapMarkerResponseDto {
  ...
  @override
  String toString() =>
      'MapMarkerResponseDto[city=$city, country=$country, id=$id, lat=$lat, lon=$lon, state=$state]';
  ...
  static List<MapMarkerResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MapMarkerResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MapMarkerResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
