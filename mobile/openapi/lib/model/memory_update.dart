...
class MemoryUpdate {
  ...
  bool operator ==(Object other) =>
      ...
      other is MemoryUpdate && other.enabled == enabled;
  ...
  static List<MemoryUpdate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MemoryUpdate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MemoryUpdate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
