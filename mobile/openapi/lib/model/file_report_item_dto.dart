...
class FileReportItemDto {
  ...
  @override
  String toString() =>
      'FileReportItemDto[checksum=$checksum, entityId=$entityId, entityType=$entityType, pathType=$pathType, pathValue=$pathValue]';
  ...
  static List<FileReportItemDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<FileReportItemDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = FileReportItemDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
