...
class PersonStatisticsResponseDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is PersonStatisticsResponseDto && other.assets == assets;
  ...
  static List<PersonStatisticsResponseDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PersonStatisticsResponseDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PersonStatisticsResponseDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
