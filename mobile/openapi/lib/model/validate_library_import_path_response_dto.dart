...
class ValidateLibraryImportPathResponseDto {
  ...
  static Map<String, ValidateLibraryImportPathResponseDto> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            ValidateLibraryImportPathResponseDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ValidateLibraryImportPathResponseDto>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
