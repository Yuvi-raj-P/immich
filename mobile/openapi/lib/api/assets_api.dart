...
class AssetsApi {
  ...
  Future<Response> getAllUserAssetsByDeviceIdWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path =
        r'/assets/device/{deviceId}'.replaceAll('{deviceId}', deviceId);
  ...
  Future<Response> getAssetInfoWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/assets/{id}'.replaceAll('{id}', id);
  ...
  ///
  /// * [int] month (required):
  Future<Response> getMemoryLaneWithHttpInfo(
    int day,
    int month,
  ) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [int] month (required):
  Future<List<MemoryLaneResponseDto>?> getMemoryLane(
    int day,
    int month,
  ) async {
    final response = await getMemoryLaneWithHttpInfo(
      day,
      month,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
    ...
    if (response.body.isNotEmpty &&
      ...
      final responseBody = await _decodeBodyBytes(response);
      return (await apiClient.deserializeAsync(
              responseBody, 'List<MemoryLaneResponseDto>') as List)
  ...
  Future<Response> playAssetVideoWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/assets/{id}/video/playback'.replaceAll('{id}', id);
  ...
  Future<Response> updateStackParentWithHttpInfo(
  ...
  ///
  /// * [UpdateStackParentDto] updateStackParentDto (required):
  Future<void> updateStackParent(
    UpdateStackParentDto updateStackParentDto,
  ) async {
    final response = await updateStackParentWithHttpInfo(
  ...
  Future<Response> viewAssetWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/assets/{id}/thumbnail'.replaceAll('{id}', id);
