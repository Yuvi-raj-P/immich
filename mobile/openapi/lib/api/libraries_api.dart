...
class LibrariesApi {
  ...
  Future<Response> deleteLibraryWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/libraries/{id}'.replaceAll('{id}', id);
  ...
  Future<List<LibraryResponseDto>?> getAllLibraries() async {
    ...
    if (response.body.isNotEmpty &&
      ...
      return (await apiClient.deserializeAsync(
              responseBody, 'List<LibraryResponseDto>') as List)
  ...
  Future<Response> getLibraryStatisticsWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/libraries/{id}/statistics'.replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<Response> removeOfflineFilesWithHttpInfo(
    String id,
  ) async {
    // ignore: prefer_const_declarations
    final path = r'/libraries/{id}/removeOffline'.replaceAll('{id}', id);
  ...
  ///
  /// * [String] id (required):
  Future<void> removeOfflineFiles(
    String id,
  ) async {
    final response = await removeOfflineFilesWithHttpInfo(
      id,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
  ...
  Future<Response> scanLibraryWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/libraries/{id}/scan'.replaceAll('{id}', id);
  ...
  Future<Response> validateWithHttpInfo(
    ...
    // ignore: prefer_const_declarations
    final path = r'/libraries/{id}/validate'.replaceAll('{id}', id);
